...
use Amghost\Console\Commands\User\DeleteUserCommand;
...
class DeleteUserCommandTest extends CommandTestCase
{
    ...
    /**
     * @var \Amghost\Console\Commands\User\DeleteUserCommand
     */
    protected $command;

    /**
     * @var \Amghost\Services\Users\UserDeletionService|\Mockery\Mock
     */
