...
class DeployServerDatabaseServiceTest extends TestCase
{
    ...
    /**
     * @var \Amghost\Services\Databases\DatabaseManagementService|\Mockery\Mock
     */
    ...
    public function setUp()
    {
        ...
        config()->set('amghost.client_features.databases.enabled', true);
        config()->set('amghost.client_features.databases.allow_random', true);
    }
    ...
    {
        config()->set('amghost.client_features.databases.allow_random', false);
     ...
     *
     * @expectedException \Amghost\Exceptions\Service\Database\NoSuitableDatabaseHostException
     */
     ...
     * @expectedException \Amghost\Exceptions\Service\Database\TooManyDatabasesException
     */
     ...
     *
     * @expectedException \Amghost\Exceptions\Service\Database\DatabaseClientFeatureNotEnabledException
     */
    public function testFeatureNotEnabled()
    {
        config()->set('amghost.client_features.databases.enabled', false);
     ...
     *
     * @return \Amghost\Services\Databases\DeployServerDatabaseService
     */
