...
class KeyCreationServiceTest extends TestCase
{
    ...
    /**
     * @var \Amghost\Contracts\Repository\ApiKeyRepositoryInterface|\Mockery\Mock
     */
    private $repository;
    ...
    public function testKeyIsCreated()
    {
        ...
        $this->getFunctionMock('\\Amghost\\Services\\Api', 'str_random')
     ...
     *
     * @return \Amghost\Services\Api\KeyCreationService
     */
