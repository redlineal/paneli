...
class ToggleTwoFactorServiceTest extends TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->config->shouldReceive('get')->with('amghost.auth.2fa.window')->once()->andReturn(self::TEST_WINDOW_INT);
     ...
     *
     * @expectedException \Amghost\Exceptions\Service\User\TwoFactorAuthenticationTokenInvalid
     */
     ...
     *
     * @return \Amghost\Services\Users\ToggleTwoFactorService
     */
