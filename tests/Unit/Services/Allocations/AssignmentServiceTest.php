...
class AssignmentServiceTest extends TestCase
{
    ...
    {
        $data = [
            'allocation_ip' => 'unit-test-static.amghost.io',
            'allocation_ports' => ['2222'],
        ];
     ...
     *
     * @expectedException \Amghost\Exceptions\Service\Allocation\CidrOutOfRangeException
     ...
     *
     * @expectedException \Amghost\Exceptions\Service\Allocation\TooManyPortsInRangeException
     ...
     *
     * @expectedException \Amghost\Exceptions\Service\Allocation\InvalidPortMappingException
     ...
     * @expectedException \Amghost\Exceptions\Service\Allocation\PortOutOfRangeException
     ...
     *
     * @return \Amghost\Services\Allocations\AssignmentService
     */
