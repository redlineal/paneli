...
use Amghost\Http\Controllers\Base\IndexController;
...
class IndexControllerTest extends ControllerTestCase
{
    ...
    /**
     * @var \Amghost\Http\Controllers\Base\IndexController
     */
    ...
    public function testIndexController()
    {
        ...
        $this->repository->shouldReceive('setSearchTerm')->with('searchTerm')->once()->andReturnSelf()
            ->shouldReceive('filterUserAccessServers')->with($model, User::FILTER_LEVEL_ALL, config('amghost.paginate.frontend.servers'))
