...
namespace Amghost\Repositories\Daemon;
...
use Amghost\Contracts\Repository\Daemon\BaseRepositoryInterface;
...
abstract class BaseRepository implements BaseRepositoryInterface
{
    ...
    public function getHttpClient(array $headers = []): Client
    {
        ...
        return new Client([
            ...
            'timeout' => config('amghost.guzzle.timeout'),
            'connect_timeout' => config('amghost.guzzle.connect_timeout'),
            'headers' => $headers,
        ]);
    }
}
