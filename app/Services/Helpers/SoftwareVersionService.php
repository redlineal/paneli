...
namespace Amghost\Services\Helpers;
...
use Amghost\Exceptions\Service\Helper\CdnVersionFetchingException;

class SoftwareVersionService
{
    const VERSION_CACHE_KEY = 'amghost:versions';
    ...
    {
        $this->cache->remember(self::VERSION_CACHE_KEY, $this->config->get('amghost.cdn.cache_time'), function () {
            try {
                $response = $this->client->request('GET', $this->config->get('amghost.cdn.url'));
