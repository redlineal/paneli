...
use Amghost\Http\Requests\Server\UpdateFileContentsFormRequest;
...
class FileActionsController extends Controller
{
    ...
    /**
     * @var \Amghost\Contracts\Repository\Daemon\FileRepositoryInterface
     */
     ...
     *
     * @param \Amghost\Contracts\Repository\Daemon\FileRepositoryInterface $repository
     */
     ...
     *
     * @param \Amghost\Http\Requests\Server\UpdateFileContentsFormRequest $request
     * @param string                                                          $uuid
     * @param string                                                          $file
     * @return \Illuminate\View\View
     *
