...
use Amghost\Services\Sftp\AuthenticateUsingPasswordService;
use Symfony\Component\HttpKernel\Exception\BadRequestHttpException;
use Amghost\Http\Requests\Api\Remote\SftpAuthenticationFormRequest;
...
class SftpController extends Controller
{
    ...
    /**
     * @var \Amghost\Services\Sftp\AuthenticateUsingPasswordService
     */
     ...
     *
     * @param \Amghost\Services\Sftp\AuthenticateUsingPasswordService $authenticationService
     */
     ...
     *
     * @param \Amghost\Http\Requests\Api\Remote\SftpAuthenticationFormRequest $request
