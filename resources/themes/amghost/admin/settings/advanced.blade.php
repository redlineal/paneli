...
@section('content-header')
    <h1>Advanced Settings<small>Configure advanced settings for Amghost.</small></h1>
    <ol class="breadcrumb">
                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <div>
                                    <input type="number" required class="form-control" name="amghost:guzzle:connect_timeout" value="{{ old('amghost:guzzle:connect_timeout', config('amghost.guzzle.connect_timeout')) }}">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div>
                                    <input type="number" required class="form-control" name="amghost:guzzle:timeout" value="{{ old('amghost:guzzle:timeout', config('amghost.guzzle.timeout')) }}">
                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <div>
                                    <input type="number" required class="form-control" name="amghost:console:count" value="{{ old('amghost:console:count', config('amghost.console.count')) }}">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div>
                                    <input type="number" required class="form-control" name="amghost:console:frequency" value="{{ old('amghost:console:frequency', config('amghost.console.frequency')) }}">
