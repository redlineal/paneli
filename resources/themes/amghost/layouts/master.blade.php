...
<html>
    <head>
        ...
        <title>{{ config('app.name', 'Amghost') }} - @yield('title')</title>
        ...
        @section('scripts')
            ...
            {!! Theme::css('css/amghost.css?t={cache-version}') !!}
        ...
        <div class="wrapper">
            <header class="main-header">
                <a href="{{ route('index') }}" class="logo">
                    <span class="logo-lg">{{ config('app.name', 'Amghost') }}</span>
                                ...
                                >
                                    <a href="{{ route('server.schedules', $server->uuidShort)}}">
                                        ...
                                        <span class="pull-right-container">
                                            <span class="label label-primary pull-right">{{ \Amghost\Models\Schedule::select('id')->where('server_id', $server->id)->where('is_active', 1)->count() }}</span>
                                        </span>
                                    </a>
                                </li>
                            @endcan
            ...
            <footer class="main-footer">
                ...
                Copyright &copy; 2015 - {{ date('Y') }} <a href="https://amghost.io/">Amghost Software</a>.
            </footer>
            @if(isset($sidebarServerList))
