...
If you've found what you believe is a security issue please email us at `lirimzm@yahoo.com`.
...
You can also find us on [Facebook](https://fb.com/lirim.zm.1). In the event that you need to get in contact with us privately feel free to contact us at `lirimzm@yahoo.com`. Try not to email us with requests for support regarding the panel, we'll probably just direct you to our Discord.
